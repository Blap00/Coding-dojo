...
public class BasicJava {
    ...
    public BasicJava() {
        ...
        this.minMaxAverage = minMaxAverage(getNumberCopyII());
    }
	...
	public String getMinMaxAverage() {
		return Arrays.toString(minMaxAverage);
	}


	public void setMinMaxAverage(double[] minMaxAverage) {
