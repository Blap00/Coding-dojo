...
<head>
	...
	<meta charset="utf-8">
	<title>Welcome</title>
<!-- CREATE A LOGINREGSTYLE.css! <link rel="stylesheet" type="text/css" href="css/loginRegStyle.css"> -->
</head>
<body>
	...
	<div id="register">
		<h2>Register</h2>
		<p><form:errors accept-charset="UTF-8" path="user.*"/></p>
		<form:form accept-charset="UTF-8" method="POST" action="/registration" modelAttribute="user">
			<p>
