...
public class StringManipulatorMain{
    public static void main(String[] args) {
        ...
        // Prueba del método concatSubstring
        System.out.println("Concatenar Substring; ");
        System.out.print("Palabra string 1; ");
        String word41= scanner.next();
        System.out.print("Desde que posicion elimina; ");
        int init42= scanner.nextInt();
        System.out.print("Hasta que posicion elimina; ");
        int end43= scanner.nextInt();
        System.out.print("Palabra string 2; ");
        String word44= scanner.next();
        System.out.println("Valor de entrega: "+manipulator.concatSubstring(word41, init42, end43, word44));
        scanner.close();
    }
}
